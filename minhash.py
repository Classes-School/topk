...
def sparse_condenser(key,  sparse_list):
    ...
    for ind, val in enumerate(sparse_list):
        if (val):
            ...
            # print(dense_list) #: tested. sparse condenser works accordingly
...
def read_all_from_disk(name):
    ...
    return output
    # print(output.get("3idx-b6xt#95.txt"))
